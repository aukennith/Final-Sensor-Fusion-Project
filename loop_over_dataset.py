...
show_only_frames = [0, 200] # step-3,4# show only frames in interval for debugging
# show_only_frames = [74,76]
# show_only_frames = [65, 100] #step-2
# show_only_frames = [150, 200] #step-1
...
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results', "fpn_resnet" )#model_name
